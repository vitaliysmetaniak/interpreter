...
public class AutoResizeTextView extends TextView {
    ...
    private CharSequence etalonText;
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.etalonText = BuildConfig.FLAVOR;
    ...
    public void setEtalonText(CharSequence text) {
        this.etalonText = text;
    }

    public void resizeText(int width, int height) {
        CharSequence text = this.etalonText.toString().isEmpty() ? getText() : this.etalonText;
                ...
                if (layout.getLineCount() > 0) {
                    ...
                    if (lastLine < 0) {
                        ...
                        if (getText().length() > end) {
                            setText(getText().subSequence(0, end) + mEllipsis);
                        }
                    }
                }
            }
